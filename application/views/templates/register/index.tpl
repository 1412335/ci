{include file="./partials/head.tpl" title="Register"}
<!-- iCheck -->
...
<div class="login-box">
	<div class="login-logo">
		<a href="{$base_url}tpl/category"><b>Admin</b>management</a>
	</div>
	<!-- /.login-logo -->
	<div class="register-box-body">
		...
		<a href="{$base_url}tpl/admin/login" class="text-center">I already have a membership</a>
	</div>
	<!-- /.login-box-body -->
</div>
